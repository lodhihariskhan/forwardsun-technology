  ...
  return (
    ...
    >
      <div className={`rounded-3xl bg-mist p-6 ${reversed ? "lg:col-start-2" : ""}`}>
        ...
        <h2 className="mt-6 text-2xl font-bold text-charcoal">{service.title}</h2>
      ...
      <div className={reversed ? "lg:col-start-1" : ""}>
        <div className="rounded-3xl border border-line bg-white p-6">
          <h3 className="text-xs font-semibold uppercase tracking-[0.14em] text-forest">
            What we handle
          </h3>
        ...
        <div className="mt-4 rounded-3xl border border-solar/25 bg-sunsoft p-6">
          <h3 className="text-xs font-semibold uppercase tracking-[0.14em] text-forest">Outcome</h3>
          <p className="mt-3 text-base font-medium leading-7 text-charcoal/78">{service.outcome}</p>
          <ButtonLink
            href="/contact"
            className="mt-5"
            variant="primary"
